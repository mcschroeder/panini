...
floatStub = ClassStub
  ...
  , functions =
    ...
    , ("__add__", Callable [Int,Float] Float)
    , ("__sub__", Callable [Int,Float] Float)
    , ("__mul__", Callable [Int,Float] Float)
    , ("__floordiv__", Callable [Int,Float] Float)
    , ("__truediv__", Callable [Int,Float] Float)
    , ("__mod__", Callable [Int,Float] Float)
    , ("__divmod__", Callable [Int,Float] (Tuple [Float,Float]))
