...
--normRelA = \case
  ...
  -----------------------------------------------------------------------------
  ω :≬: _ | anyBot ω -> Left False
  _ :≬: ω | anyBot ω -> Left False
  ω :∥: _ | anyBot ω -> Left True
  _ :∥: ω | anyBot ω -> Left True
  -----------------------------------------------------------------------------
  ω₁           :≬: ω₂           | ω₁ == ω₂ -> Left True
  ...
  -----------------------------------------------------------------------------
  ω₁           :∥: ω₂           | ω₁ == ω₂ -> Left False
  ω₁           :∥: (ω₂ :+: 𝗭̂ n̂) | ω₁ == ω₂ -> Left (not $ AInt.member 0 n̂)
  ω₁           :∥: (ω₂ :-: 𝗭̂ n̂) | ω₁ == ω₂ -> Left (not $ AInt.member 0 n̂)
  (ω₁ :+: 𝗭̂ n̂) :∥: ω₂           | ω₁ == ω₂ -> Left (not $ AInt.member 0 n̂)
  (ω₁ :-: 𝗭̂ n̂) :∥: ω₂           | ω₁ == ω₂ -> Left (not $ AInt.member 0 n̂)
  -----------------------------------------------------------------------------
