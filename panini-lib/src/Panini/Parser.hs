...
identChar = satisfy (\x -> isAlphaNum x || x == '_' || x == '\'' 
                                        ...
                                        || x == undr)
 where
  hat  = '\x0302' -- U+0302 ◌̂ COMBINING CIRCUMFLEX ACCENT
  bar1 = '\x0304' -- U+0305 ◌̄ COMBINING MACRON
  bar2 = '\x0305' -- U+0305 ◌̅ COMBINING OVERLINE
  undr = '\x0332' -- U+0332 ◌̲ COMBINING LOW LINE
